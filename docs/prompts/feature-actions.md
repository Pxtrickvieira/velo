...
- Use blocos de código TypeScript com path no comentário da primeira linha
- Separe cada arquivo com um heading ###
- Não gere explicações longas entre arquivos — o código deve ser autoexplicativo